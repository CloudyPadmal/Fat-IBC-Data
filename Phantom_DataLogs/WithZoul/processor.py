...
PhantomNode2 = '0012.4b00.11e6.5d6b'
...
if SKIN_NODE:
  (P1_E5, S_P1_E5, P2_E5, S_P2_E5) = extractPacketData(Ev5)
...
if SKIN_NODE:
  ax5.scatter(S_P1_E5, P1_E5, s=10, label='from node 1')
  ax5.plot([np.mean(P1_E5) for _ in range(PACKETS)], label='node 1 mean')
  ax5.scatter(S_P2_E5, P2_E5, s=10, label='from node 2')
  ax5.plot([np.mean(P2_E5) for _ in range(PACKETS)], label='node 2 mean')
  ax5.set_xlim(0, PACKETS)
  ax5.legend()
  ax5.set_title('Eaves Skin')
  ax5.set_xlabel('Sequence number')

  ax6.scatter(S_P1_P2, P1_P2, s=10, label='from node 1')
  ax6.plot([np.mean(P1_P2) for _ in range(PACKETS)], label='node 1 mean')
  ax6.scatter(S_P2_P1, P2_P1, s=10, label='from node 2')
  ax6.plot([np.mean(P2_P1) for _ in range(PACKETS)], label='node 2 mean')
  ax6.set_xlim(0, PACKETS)
  ax6.legend()
  ax6.set_title('In-body')
