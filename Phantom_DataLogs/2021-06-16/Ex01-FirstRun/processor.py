...
prr = 'N1:' + str(round((len(P1_E1)/200),2)) + ' | N2:' + str(round((len(P2_E1)/200),2))
...
prr = 'N1:' + str(round((len(P1_E2)/200),2)) + ' | N2:' + str(round((len(P2_E2)/200),2))
...
prr = 'N1:' + str(round((len(P1_E3)/200),2)) + ' | N2:' + str(round((len(P2_E3)/200),2))
...
ev3.text(0.3, 0.95, prr, transform=ev3.transAxes, fontsize=8,
        verticalalignment='center', bbox=props)

prr = 'N1:' + str(round((len(P1_E4)/200),2)) + ' | N2:' + str(round((len(P2_E4)/200),2))
...
ev4.text(0.3, 0.95, prr, transform=ev4.transAxes, fontsize=8,
        verticalalignment='center', bbox=props)

if SKIN_NODE:
  prr = 'N1:' + str(round((len(P1_E5)/200),2)) + ' | N2:' + str(round((len(P2_E5)/200),2))
  ...
  ev5.set_ylim(MIN_RSSI, MAX_RSSI)
  ev5.set_title('Eaves Skin')
  ev5.set_xlabel('Sequence number')
  ev5.text(0.3, 0.95, prr, transform=ev5.transAxes, fontsize=8,
        verticalalignment='center', bbox=props)

prr = 'N1:' + str(round((len(P1_P2)/200),2)) + ' | N2:' + str(round((len(P2_P1)/200),2))
